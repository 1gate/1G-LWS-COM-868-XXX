...
wget https://github.com/gotthardp/lorawan-server/releases/download/v0.5.0-pre.0/lorawan-server_0.5.0-pre.0_all.deb
dpkg -i lorawan-server_0.5.0-pre.0_all.deb
